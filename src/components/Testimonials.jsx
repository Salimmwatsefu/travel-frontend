...
function Testimonials() {
  ...
  <section className=" text-gray-800 text-center">
    ...
    <div className="grid md:grid-cols-3 ml-28">
      ...
      <div className="mb-6 lg:mb-0 w-60">
        <div className="bg-orange-200 block rounded-lg shadow-lg">
          ...
          <div className="p-6">
            ...
            <p> blanditiis praesentium accusamus voluptatum deleniti atque corrupti.</p>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6 lg:mb-0 w-60 mt-16 ">
        <div className="bg-orange-200 block rounded-lg shadow-lg ">
          <div className="relative overflow-hidden bg-no-repeat bg-cover">
          ...
          <div className="p-6">
            ...
            <p>vulputate. Ut vulputate est non quam
              dignissim elementum. Donec a </p>
          </div>
        </div>
      </div>
